...
use NoGlitchYo\Dealdoh\Client\Transport\TcpTransport;
use NoGlitchYo\Dealdoh\Client\Transport\UdpTransport;
        ...
        return [
            ...
            LoggerInterface::class => function (ContainerInterface $container): LoggerInterface {
                return new Logger('logger', [
                    $container->get(RotatingFileHandler::class)
                ]);
            },
            RotatingFileHandler::class => function (ContainerInterface $container): HandlerInterface {
                return new RotatingFileHandler('log/all.log');
            },
        ];
    }
}
